        ...
        records.append(
            {
                ...
                "expert_selected": hrec.get("final_model_selected", max(hrec["selector"]["average_weights_test"], key=hrec["selector"]["average_weights_test"].get)),
                "selector_weight_top_expert": max(hrec["selector"]["average_weights_test"], key=hrec["selector"]["average_weights_test"].get),
                "validation_guard_used": hrec["selector"].get("validation_guard", {}).get("used", False),
